...
//            val n = Notification.Builder(this, AnotherMovieApplication.NOTIFICATION_CHANNEL_ID).build()
//            startForeground(1, n)
//        }
//    }
//
...
//                            movieId = response.getString(EntityDBMovieReview.Companion.JSON_ID)
//                            page = response.getLong(EntityDBMovieReview.Companion.JSON_PAGE)
//                            totalPages = response.getString(EntityDBMovieReview.Companion.JSON_TOTAL_PAGES)
//                            val arr = response.getJSONArray(EntityDBMovieReview.Companion.JSON_ARRAY_RESULTS)
//                            val contentValuesArray = arrayOfNulls<ContentValues>(arr.length())
//                            for (i in 0 until arr.length()) {
//                                val movie_review = arr.getJSONObject(i)
//                                val item: EntityDBMovieReview = EntityDBMovieReview.Companion.fromJSON(movie_review, movieId)
//                                contentValuesArray[i] = EntityDBMovieReview.Companion.contentValuesFromObj(item)
//                            }
